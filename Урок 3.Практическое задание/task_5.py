...
LIS = [-55, -69, -5, 72, -41, -58, -79, 58, 74, 1]

MAX_ITEM = max([x for x in LIS if x < 0])
print(f'Максимальный отрицательный элемент в данном массиве = {MAX_ITEM}, '
      f'его индекс {LIS.index(MAX_ITEM)}.')
